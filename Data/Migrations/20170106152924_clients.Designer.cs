...
namespace AlexWebApp.Data.Migrations
{
    ...
    [Migration("20170106152924_clients")]
    partial class clients
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("AlexWebApp.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("AlexWebApp.Models.Client", b =>
                {
            ...
            modelBuilder.Entity("AlexWebApp.Models.EmailPromo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("AlexWebApp.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("AlexWebApp.Models.Client", b =>
                {
                    b.HasOne("AlexWebApp.Models.Address", "BillingAddress")
                        .WithMany()
                        .HasForeignKey("BillingAddressAddressId");

                    b.HasOne("AlexWebApp.Models.Address", "MailingAddress")
                        .WithMany()
            ...
            modelBuilder.Entity("AlexWebApp.Models.EmailPromo", b =>
                {
                    b.HasOne("AlexWebApp.Models.Client")
